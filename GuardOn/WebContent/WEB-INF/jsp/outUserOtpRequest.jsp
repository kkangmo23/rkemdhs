...
<div class="container">
  <div class="header"><strong>
    <!-- end .header -->
  Guard-ON</strong> 외주 사용자 OTP 발급요청</div>
  <div class="sidebar1">
    <ul class="nav">
  ...
  <div class="content">
    ...
    <form action="outSendRequest.do" method="post">
     ...
     <tr>
     	...
     	<!-- <textarea name="requestDesc" id="requestDesc" rows="3" cols="60"></textarea> -->
     	</td>
     </tr>      
    ...
    <!-- 
		<form action="outUserOtp.do" method="post">
		  <input type="submit" class="content" value="OTP 발급" />
		  <br/>
		 	<br/>
		</form>
		 -->
